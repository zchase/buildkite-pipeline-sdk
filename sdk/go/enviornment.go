...
func (e environment) AgentMetaData() string {
    str := os.Getenv("BUILDKITE_AGENT_META_DATA")
    return str
}
...
func (e environment) AgentEndpoint() bool {
...
func (e environment) CommandExitStatus() string {
